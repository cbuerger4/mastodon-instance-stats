...
mastodon %>%
  ...
  mutate(users_c = cut(users, 
                       breaks = c(0, 1, 5, 10, 100, 1000, 5000, 10000, 50000, 100000),
                       labels = c("1", "2-5", "6-10", "11-100", "101-1.000", "1.001-5.000",
                                  "5.001-10.000", "10.001-50.000", "50.001-100.000"))) %>%
  ggplot(data = ., aes(x = users_c)) +
  geom_bar() +
  scale_y_continuous(breaks = seq(0, 100, 25), minor_breaks = seq(0, 100, 5)) +
...
mastodon %>%
  ...
  ggplot(data = ., aes(x = https_score)) +
  geom_histogram(binwidth = 5) +
  labs(title = "Mastodon Instances by HTTPS Score",
       y = "# of Instances", x = "HTTPS Score")
```
...
This is just a quick demo proof of concept by [@jemus42@mastodon.social](https://mastodon.social/@jemus42) / @jemus42 on birdsite.  
